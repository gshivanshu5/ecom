...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_CvlyZEBN4iv0Ek",
      key_secret: "IFi0QWFgnmTUV3tOqVgrDqpZ",
  ...
  return (
    <Layout >
      <div className=" bg-gray-100 pt-5 w-full h-[500px] overflow-auto" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 ">
            ...
            {cartItems.map((item, index) => {
              ...
              return (
                <div className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start relative" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }} key={index}>
